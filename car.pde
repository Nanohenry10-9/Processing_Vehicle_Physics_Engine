...
float tires[] = new float[4], tspeeds[] = new float[4];
float tlocx[] = new float[4], tlocy[] = new float[4];
...
void updatePhysics() {
  ...
  tspeeds[2] += 0.4;
  tspeeds[3] += 0.4;
  if (tires[0] > height / 2 + terrain(rwidth / 2 - 30, rwidth / 2 + 20) - 50 * wheelsize) {
    float b = tires[0] - (height / 2 + terrain(rwidth / 2 - 30, rwidth / 2 + 20) - 50 * wheelsize);
    tires[0] = height / 2 + terrain(rwidth / 2 - 30, rwidth / 2 + 20) - 50 * wheelsize - 2;
    tspeeds[0] *= -0.6 * min(b, 1);
  }
  if (tires[1] > height / 2 + terrain(rwidth / 2 + 30, rwidth / 2 + 20) - 50 * wheelsize) {
    float b = tires[1] - (height / 2 + terrain(rwidth / 2 + 30, rwidth / 2 + 20) - 50 * wheelsize);
    tires[1] = height / 2 + terrain(rwidth / 2 + 30, rwidth / 2 + 20) - 50 * wheelsize - 2;
    tspeeds[1] *= -0.6 * min(b, 1);
  }
  if (tires[2] > height / 2 + terrain(rwidth / 2 - 30, rwidth / 2 - 30) - 50 * wheelsize) {
    float b = tires[2] - (height / 2 + terrain(rwidth / 2 - 30, rwidth / 2 - 30) - 50 * wheelsize);
    tires[2] = height / 2 + terrain(rwidth / 2 - 30, rwidth / 2 - 30) - 50 * wheelsize - 2;
    tspeeds[2] *= -0.6 * min(b, 1);
  }
  if (tires[3] > height / 2 + terrain(rwidth / 2 + 30, rwidth / 2 - 30) - 50 * wheelsize) {
    float b = tires[3] - (height / 2 + terrain(rwidth / 2 + 30, rwidth / 2 - 30) - 50 * wheelsize);
    tires[3] = height / 2 + terrain(rwidth / 2 + 30, rwidth / 2 - 30) - 50 * wheelsize - 2;
